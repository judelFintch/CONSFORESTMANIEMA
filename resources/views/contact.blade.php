            ...
            <div class="space-y-5 reveal-left">
                ...
                @foreach([
                    [
                        ...
                        'title' => 'Siège Social',
                        'lines' => ['Kinshasa, RDC', 'Bureau : Kindu, Province du Maniema'],
                    ...
                    [
                        ...
                        'title' => 'Téléphone',
                        'lines' => ['+243 XXX XXX XXX', 'Lun–Ven, 8h–17h (Kinshasa)'],
...
<section class="py-12 bg-institutional">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-5 text-white">
            @foreach([
                ['val' => 'Kinshasa', 'label' => 'Siège social', 'sub' => 'République Démocratique du Congo', 'c' => '#4ade80'],
